...
make_image(folder=folder, output='./sorted_merged_hs.png', image_size=image_size, sort_type='hs', step=stepsize, replace=True)
make_image(folder=folder, output='./sorted_merged_sv.png', image_size=image_size, sort_type='sv', step=stepsize, replace=True)
make_image(folder=folder, output='./sorted_merged_hv.png', image_size=image_size, sort_type='hv', step=stepsize, replace=True)
